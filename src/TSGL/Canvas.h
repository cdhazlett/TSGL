...
private:
  ...
  // 3D Canvas Additions
  bool canvas3DView = true;
  bool cameraMovementEnabled = true;
  bool isMouseDown, isShiftDown, isCtrlDown = false;

  // Instance variables for the Canvas camera setup
  glm::vec3 cameraEyePosition = glm::vec3(0.f);
  glm::vec3 cameraLookPoint = glm::vec3(0.f);
  ...
  void handleCameraButtonStateChange(int key, int action);
