/*
 * Solid3D.h extends Shape3D and provides a class for drawing a 3d solid object.
 */

#ifndef SOLID3D_H_
#define SOLID3D_H_

#include "Shape3D.h"       // For extending our Shape object
#include "TsglAssert.h"  // For unit testing purposes

namespace tsgl {

/*! \class Solid3D //TODO
 *  \brief Draw an arbitrary 3D solid polygon with colored vertices.
 ...
 */
class Solid3D : public Shape3D {
protected:
  ColorFloat outlineColor; ///< Color of the Solid's outline.
public:
     ...
     */
    Solid3D(int numVertices, const ColorFloat& c, const ColorFloat& outlineC = BLACK);
