...
Re-\/compile and run. The screen should now be red. It took 0.\-007797 seconds to color all of the pixels.
...
Re-\/compile and run. The screen should still be red. It took 0.\-027261 seconds to color all of the pixels with four threads (about 1/4 of the original time) on our machine.
...
\}
\end{DoxyCode}
 Recompile and run. There should now be four differently colored sections! (It took 0.\-044397 seconds to color the the screen four different colors on our machine!)
...
Compile and run the program, passing these command-\/line arguments\-: 700, 700, 10. There should now be 10 differently colored sections of the Canvas! (It took 0.\-116421 seconds to color the 10 different sections on our machine!)
